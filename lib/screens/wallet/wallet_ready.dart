...
class WalletReady extends StatelessWidget {
  const WalletReady({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        Container(
          margin: new EdgeInsets.fromLTRB(15, 30, 80, 0),
          child: Text("Your wallet is ready",
        ...
        Container(
          margin: new EdgeInsets.fromLTRB(15, 15, 10, 0),
          child: Text(
              "Your wallet is still empty, so your next step might be to receive Monero from somebody",
              textDirection: TextDirection.ltr,
              style: Theme.of(context).textTheme.bodyText2),
        ),
        Container(
